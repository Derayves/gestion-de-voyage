...
$num_im=@$_POST["num_im"];
$mess1='';
/*Code écrit du 30 Juin au 30 Juillet 2023 à Antananarivo

   Contact: randrianariveloderayves@gmail.com
 */
?>
...
?>
<?php 
/*rq1="update tb_place set disponible='oui' where num_place='"+num_place+"'",
						rq2="delete from tb_occupation where id_place='"+num_place+"'";*/
//libérer une place occupées
